...
// Looking for string: MAIN.DEFNS
	...
	//
	wire		tx_wb_fmsim_stall, rx_wb_fmsim_stall;
	wire		tx_wb_fmsim_ack,   rx_wb_fmsim_ack;
	wire	[31:0]	tx_wb_fmsim_data,  rx_wb_fmsim_data;
	//
	//
	// UART interface
	//
...
// `include "builddate.v"
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb, component fmsim
	// Verilator lint_off UNUSED
	wire		wb_fmsim_cyc, wb_fmsim_stb, wb_fmsim_we;
	wire	[10:0]	wb_fmsim_addr;
	wire	[31:0]	wb_fmsim_data;
	wire	[3:0]	wb_fmsim_sel;
	wire		wb_fmsim_stall, wb_fmsim_ack, wb_fmsim_err;
	wire	[31:0]	wb_fmsim_idata;
	// Verilator lint_on UNUSED
...
`ifdef	VERILATOR
	...
	//
	fmxmit
	fmxmiti(i_clk, i_reset, audio_en, rf_en,
		wb_fmsim_cyc, wb_fmsim_stb && !wb_fmsim_addr[2], wb_fmsim_we,
			wb_fmsim_addr[1:0], wb_fmsim_data, wb_fmsim_sel,
			tx_wb_fmsim_stall, tx_wb_fmsim_ack, tx_wb_fmsim_data,
	...
	//
	fmdemod
	fmdemodi(i_clk, i_reset, audio_en, rf_en,
		wb_fmsim_cyc, wb_fmsim_stb && wb_fmsim_addr[2], wb_fmsim_we,
			wb_fmsim_addr[1:0], wb_fmsim_data, wb_fmsim_sel,
			rx_wb_fmsim_stall, rx_wb_fmsim_ack, rx_wb_fmsim_data,
		o_rf_data, o_pwm_audio,
		rfdbg_sel, rxdbg_ce, rxdbg_data, rxdbg_hist);
`else
	reg	r_tx_wb_fmsim_ack, r_rx_wb_fmsim_ack;

	assign	tx_wb_fmsim_stall = 0;
	assign	rx_wb_fmsim_stall = 0;
	always @(posedge i_clk)
		r_tx_wb_fmsim_ack <= wb_fmsim_stb && !wb_fmsim_addr[2];
	always @(posedge i_clk)
		r_rx_wb_fmsim_ack <= wb_fmsim_stb && wb_fmsim_addr[2];
	assign	tx_wb_fmsim_ack = r_tx_wb_fmsim_ack;
	assign	rx_wb_fmsim_ack = r_rx_wb_fmsim_ack;
	assign tx_wb_fmsim_data = 0;
	assign rx_wb_fmsim_data = 0;
`endif

	assign	o_pwm_shutdown_n = audio_en;
	assign	o_pwm_gain = audio_en;
	assign	wb_fmsim_stall = tx_wb_fmsim_stall
				|| rx_wb_fmsim_stall;
	assign	wb_fmsim_ack = tx_wb_fmsim_ack
				|| rx_wb_fmsim_ack;
	assign	wb_fmsim_idata = (tx_wb_fmsim_ack)
			? tx_wb_fmsim_data : rx_wb_fmsim_data;
