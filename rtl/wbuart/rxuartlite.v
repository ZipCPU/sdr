...
module rxuartlite(i_clk, i_uart_rx, o_wr, o_data);
	parameter	[4:0]		TIMING_BITS = 10;
`ifdef	FORMAL
	parameter  [(TIMING_BITS-1):0]	CLOCKS_PER_BAUD = 16; // Necessary for formal proof
`else
	parameter  [(TIMING_BITS-1):0]	CLOCKS_PER_BAUD = 868;	// 115200 MBaud at 100MHz
`endif
...
`endif
	...
	// parameter	TIMING_BITS = 10;
	// parameter [(TIMING_BITS-1):0] CLOCKS_PER_BAUD = 868;
	// localparam	TB = TIMING_BITS;
